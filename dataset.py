...
catalog_train_files, catalog_valid_files,catalog_test_files = get_dejavu_dataset('A1')

print("Dataset size:", len(catalog_train_files))
print("First data ID:", catalog_train_files.data_ids[0])
print("Graph details for the first dataset entry:")
print("Number of nodes:", len(catalog_train_files.graphs[0].nodes()))
print("Number of edges:", len(catalog_train_files.graphs[0].edges()))